...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx left_drive = hardwareMap.get(DcMotorEx.class, "left_drive");
//        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "leftRear");
        DcMotorEx right_drive = hardwareMap.get(DcMotorEx.class, "right_drive");
//        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "rightFront");

        motors = Arrays.asList(left_drive, right_drive);
        leftMotors = Collections.singletonList(left_drive);
        rightMotors = Collections.singletonList(right_drive);
