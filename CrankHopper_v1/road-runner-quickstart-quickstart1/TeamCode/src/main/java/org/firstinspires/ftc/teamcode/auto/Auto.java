...
public class Auto extends LinearOpMode {
    ...
    public static double bottomPos = 0.36;
...
//        ------------------------ Start point to Backdrop ------------------------------
        ...
        TrajectorySequence trajectoryseq = drive.trajectorySequenceBuilder(startPose)
                ...
                .splineToConstantHeading(new Vector2d(58,-40),0)
...
//  ------------------ Backdrop to First Two intake -----------------------------
                ...
                .splineToConstantHeading(new Vector2d(-52.8,-10),Math.PI)

                .UNSTABLE_addTemporalMarkerOffset(0.01, () -> {
                    intake.IntakeMotor.setPower(-1);
                    //intake.intakeStack(0.38);

                        intake.IntakeTwoPixel(0.32, bottomPos);
                ...
                .UNSTABLE_addTemporalMarkerOffset(1, ()->{
                    double pos = bottomPos;
                    while(pos <= (bottomPos + 0.12)){
                        intake.intakeStack(pos);
                        pos += 0.03;
                    }
                    intake.intakeInit();
                })
                ...
                .splineToConstantHeading(new Vector2d(58,-31),0)

//                .splineToConstantHeading(new Vector2d(52,-33),0)
//                .splineToConstantHeading(new Vector2d(56,-33),0)
//                .UNSTABLE_addTemporalMarkerOffset(0.0000001, () -> {
...
//                })
//                .splineToConstantHeading(new Vector2d(-52.5,-11),Math.PI)
//                .UNSTABLE_addTemporalMarkerOffset(0.00001, () -> {
//                    intake.IntakeMotor.setPower(-1);
//                    //intake.intakeStack(0.38);
//                    for (int i = 0 ; i<3; i++) {
//                        intake.IntakeTwoPixel(0.41, 0.43);
//                    }
//                    //.waitSeconds(0.01)
//                })
//                .waitSeconds(0.01)
...
//                })
//                .splineToConstantHeading(new Vector2d(52,-33),0)
//                .splineToConstantHeading(new Vector2d(57,-33),0)
//                .UNSTABLE_addTemporalMarkerOffset(0.0000001, () -> {
//
//                    intake.IntakeMotor.setPower(0);
//                    outake.outakeGrip.setPosition(OuttakePixelDrop);
